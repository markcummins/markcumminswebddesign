				...
				<div class="col-lg-10 col-lg-offset-1">
					<div class="modal-body">
						...
						<ul class="list-inline">
							...
							<li>Launch: <span class="label label-primary">March 2015</span></li>
				...
				<div class="col-lg-10 col-lg-offset-1">
					<div class="modal-body">
						...
						<h4 class="item-intro text-muted"><i class="fa fa-plus-circle"></i> Features</h4>
							...
							<ul class="list-inline">
								<li>Date: Oct 2014</li>
								<li>Status: <span class="label label-primary">V1.0 Live</span></li>
			...
			<div class="row">
				<div class="col-lg-10 col-lg-offset-1">
					<div class="modal-body">
						...
						<h2>Trommons</h2>
						<img class="img-responsive img-centered" src="<?php echo base_url('assets/img/portfolio/logo-trommons-plain.png');?>" alt="">
						</a>
						<br/>
						...
						translation services for their non-profit projects collaborate.
						<br/> <br/> 
						The Translation Commons offers language volunteers the opportunity <br/>
						to work with some of the world’s most exciting global organisations <br/>
						on non-profit language projects. <br/><br/>
						It offers organisations the opportunity to work with enthusiastic and <br/>
						motivated language volunteers.<br/><br/>

						<ul class="list-inline">
							<li>Date: November 2013</li>
							<li>Status: <span class="label label-primary">Live</span></li>
						</ul>						
						<br/>
						<br/>
						<button type="button" class="btn btn-primary" data-dismiss="modal"><i class="fa fa-times"></i> Close Project</button>																				
			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="modal-body">
						...
						<a href="http://www.innovatelimerick.ie/" target="_blank">
							<h2>Innovate Limerick</h2>
							<img class="img-responsive img-centered" src="assets/img/portfolio/logo-il-plain.png" alt="">
						</a>						
						<p class="item-intro text-muted"><i class="fa fa-wordpress"></i> Wordpress WebSite</p>
